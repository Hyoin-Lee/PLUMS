<x-dashboard>
    <h2 class="text-xl font-semibold text-gray-800 mb-2">Create New Tag</h2>
    <form action="{{ route('tags.store') }}" method="POST">
        ...
        <div class="flex flex-row items-center justify-center gap-2">
            <button type="submit" class="bg-purple-600 hover:bg-purple-700 text-white py-2 px-4 rounded-md transition duration-300">Create Tag</button>
